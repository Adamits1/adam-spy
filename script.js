        ...
        this.defaultWordPacks = [
            {
                ...
                name: 'Vietas',
                words: [
                    'Pludmale', 'Restorāns', 'Slimnīca', 'Skola', 'Lidosta', 'Bibliotēka', 'Sporta zāle', 'Parks',
                    'Kinoteātris', 'Tirdzniecības centrs', 'Birojs', 'Viesnīca', 'Muzejs', 'Zoodārzs', 'Baznīca', 'Banka'
                ]
            },
            {
                id: 'objects',
                name: 'Priekšmeti',
                words: [
                    'Viedtālrunis', 'Automašīna', 'Grāmata', 'Ģitāra', 'Kamera', 'Klēpjdators', 'Pulkstenis', 'Velosipēds',
                    'Austiņas', 'Mugursoma', 'Saulesbrilles', 'Lietussargs', 'Klaviatūra', 'Spogulis', 'Maks', 'Spilvens'
                ]
            },
            {
                id: 'activities',
                name: 'Aktivitātes',
                words: [
                    'Gatavošana', 'Dejošana', 'Peldēšana', 'Lasīšana', 'Gleznošana', 'Dziedāšana', 'Spēlēšana', 'Pārgājieni',
                    'Iepirkšanās', 'Dārzkopība', 'Rakstīšana', 'Vingrošana', 'Ceļošana', 'Fotografēšana', 'Meditācija', 'Uzkopšana'
                ]
            },
            {
                id: 'animals',
                name: 'Dzīvnieki',
                words: [
                    'Lauva', 'Zilonis', 'Delfīns', 'Ērglis', 'Tīģeris', 'Pingvīns', 'Žirafe', 'Haizivs',
                    'Tauriņš', 'Astoņkājis', 'Ķengurs', 'Panda', 'Vilks', 'Flamingo', 'Zebra', 'Pūce'
                ]
            }
        ];
